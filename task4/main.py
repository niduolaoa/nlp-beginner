from feature import pre_process, Glove_embedding
...
with open('../../datasets/CoNLL-2003/test.txt', 'r') as f:
    temp = f.readlines()

data = temp[2:]
test_zip = pre_process(data)

with open('/shared_data/pretrained_models/glove.6B.50d.txt', 'rb') as f:  # for glove embedding
    lines = f.readlines()
