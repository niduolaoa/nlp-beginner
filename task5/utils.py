...
def data_loader(eos_token="[EOS]", batch_size=32, device="cpu", data_file_path='../../datasets/poetryFromTang.txt', max_length=128):
    TEXT = data.Field(eos_token=eos_token, batch_first=True, include_lengths=True)
    data_set = PoetryDataset(TEXT, data_file_path, max_length)
